    ...
    public class EmailModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email)
            {
                ...
                if (!result.Succeeded)
                {
                    StatusMessage = "Greška prilikom promjene email adrese.";
                ...
                {
                    StatusMessage = "Greška prilikom promjene korisničkog imena.";
                    return RedirectToPage();
                }

                await _signInManager.RefreshSignInAsync(user);
                StatusMessage = "Vaša email adresa je uspješno promijenjena.";
                return RedirectToPage();
            }

            StatusMessage = "Vaša email adresa nije promijenjena.";
            return RedirectToPage();
        }
    }
}
